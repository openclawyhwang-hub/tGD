---
name: tgd-git-workflow-and-versioning
...
Target ~100 lines per commit/PR. Changes over ~1000 lines should be split. See the splitting strategies in `tgd-code-review-and-quality` for how to break down large changes.
