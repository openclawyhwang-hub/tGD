---
name: tgd-incremental-implementation
...
5. **Commit** -- save your progress with a descriptive message (see `tgd-git-workflow-and-versioning` for atomic commit guidance)
