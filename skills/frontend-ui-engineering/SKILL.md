...
**Before implementing any UI, read `tGD/<feature-name>/define/DESIGN.md`.** The Visual Direction, Anti-patterns, Design Tokens, and Typography Scale sections are the source of truth for all design decisions. This skill covers code architecture, component patterns, state management, and accessibility — not visual design rules.
