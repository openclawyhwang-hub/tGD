...
Agent：執行所有測試...
→ 47 通過，1 失敗
→ test_login_empty_password：預期錯誤，卻得到成功
...
上面的指令是入口點。這個 pack 包含 25 個 skills——24 個生命週期 skill 加上 `using-agent-skills` 元 skill。
...
2. 🔧 探索[全部 25 個 Skills](#全部-25-個-skills)看有什麼可用
