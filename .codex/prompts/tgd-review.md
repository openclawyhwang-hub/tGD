...
**Core flow:**
1. `tgd-code-review-and-quality` — five-axis review with severity labels (Nit/Optional/FYI), ~100 lines per change
...
Severities: 🔴 Critical (must fix) · 🟡 Optional (should fix) · 🟢 Nit (FYI)
