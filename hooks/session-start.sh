...
# Injects the using-tGD meta-skill into every new session
...
$CONTENT" \
  ...
  echo '{"priority": "INFO", "message": "tGD: using-tGD meta-skill not found. Skills may still be available individually."}'
fi
