...
- [ ] `tGD/plan/PRD.md` exists and is non-empty.
- [ ] `tGD/plan/SPEC.md` exists and is non-empty.
- **If missing:** STOP. Tell user: "Specs are missing. Please run `/tgd-define` first."
- [ ] If SPEC has Frontend/Full-stack: `tGD/plan/DESIGN.md` exists.
...
2. Parse `tGD/plan/TASKS.md` and create issues via Jira REST API v2.
