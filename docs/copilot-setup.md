...
cat /path/to/tGD/skills/test-driven-development/SKILL.md > .github/skills/test-driven-development/SKILL.md
cat /path/to/tGD/skills/code-review-and-quality/SKILL.md > .github/skills/code-review-and-quality/SKILL.md
```
...
Copilot supports specialized agent personas. Use the tGD agents:
...
cp /path/to/tGD/agents/code-reviewer.md .github/agents/code-reviewer.agent.md
cp /path/to/tGD/agents/test-engineer.md .github/agents/test-engineer.agent.md
cp /path/to/tGD/agents/security-auditor.md .github/agents/security-auditor.agent.md
```
